...
const Profile = () => {
  return (
    <div>
      <div className="relative mb-6 flex items-center justify-center transition-transform duration-1000 transform scale-100">
        <div className="relative flex items-center justify-center">
          <div className="w-24 h-24 sm:w-40 sm:h-40 lg:w-48 lg:h-48 rounded-full overflow-hidden flex items-center justify-center">
            <img
              ...
              src="/src/images/oguntisamuel.jpg"
              alt="ProfileImage"
            />
          </div>
        </div>
      </div>
      <div className="w-full flex flex-col items-center justify-center text-center transition-opacity duration-1000 opacity-100 ">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          ...
          <a
            href="https://www.linkedin.com/in/samogunti/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://www.credly.com/users/samogunti"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="mailto:oguntisamuel@gmail.com"
          ...
          <a href="https://samuelarry.medium.com/" className="duration-300 cursor-pointer text-xl sm:text-2xl text-black hover:text-gray-500">
          <FaMediumM className=" h-1em w-1em" ></FaMediumM>
          </a>
        </div>
      </div>
      <Icons />
      <div className="w-full flex flex-col items-center mt-8 ">
        <a
          href="SamuelOgunti_TechnicalCurricullumArchitectResume.pdf"
          download="SamuelOgunti_TechnicalCurricullumArchitectResume.pdf"
        ...
        <button className="w-full mt-2 py-2 px-4 bg-gray-100 text-gray-700 font-semibold border border-gray-700 rounded-lg shadow-md hover:bg-gray-200 transition duration-300 ease-in-out flex items-center justify-center gap-2">
          <a href="tel:+18135770389">Contact Me</a>
        </button>
      </div>
    </div>
  );
